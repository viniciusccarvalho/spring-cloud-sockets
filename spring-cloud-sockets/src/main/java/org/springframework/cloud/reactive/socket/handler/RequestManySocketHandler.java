 ...
 */
public class RequestManySocketHandler extends AbstractReactiveSocketMethodHandler {
	@Override
	public Mono<RSocket> invoke(MethodHandler methodHandler) {
		return Mono.just(new AbstractRSocket() {
			@Override
			public Flux<Payload> requestStream(Payload payload) {
				return (Flux<Payload>)methodHandler.invoke(payload);
			}
		});
	}
	...
	public boolean accepts(ExchangeMode exchangeMode) {
		return exchangeMode == ExchangeMode.REQUEST_MANY;
	}
}
