 ...
 */
public class RequestManyRemoteHandler extends AbstractRemoteHandler {
	public RequestManyRemoteHandler(RSocket socket, ServiceHandlerInfo info, Method method) {
